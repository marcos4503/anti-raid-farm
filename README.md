...
- Set a cooldown for creating Raids. After a player with the "Bad Omen" effect enters a Village and starts a Raid, an internal cooldown will begin, and they will only be able to start another Raid if the cooldown reaches zero. This cooldown is configurable by you, and individual for each player.
...
This mod requires Minecraft Java with Forge/NeoForge Mod Loader installed. You can see the supported Minecraft versions in Releases page.
...
<p align="center">
    <a href="https://www.paypal.com/donate/?hosted_button_id=MVDJY3AXLL8T2" target="_blank">
        <img src=".github/assets/paypal-donate.png" alt="Donate" />
    </a>
</p>